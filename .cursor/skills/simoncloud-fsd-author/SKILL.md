...
## Activation context
Este skill se activa cuando el agente recibe instrucciones para crear, modificar o revisar el `docs/FSD_v1.md` de SimonCloud o cualquier caso de uso (FSD-UC-NNN).

## Context / Inputs requeridos
- `docs/PRD_v1.md` — User Stories que se deben especificar.
- `docs/BRD_v2.md` — Business Rules (BR-NNN) de referencia.
- `docs/dti/DTI_borrador.md` — Stack tecnológico autoritativo.
- `old-docs/` — Contexto histórico de UX y Journeys.

## Reasoning (pasos en orden)
1. Leer el PRD-US o PRD-REQ objetivo de la tarea.
2. Identificar el BR-NNN relacionado en BRD_v2.md.
...
## Output esperado
- Sección `### N.N FSD-UC-NNN – [Nombre]` completa en `docs/FSD_v1.md`.

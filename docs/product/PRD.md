<!--
status: vivo
capa: product (implementación, release/3.0.0+)
baseline_ref: docs/baseline/PRD.md  (tag release/2.0.0)
modo: LFSD ⚡ (mantenido sprint-a-sprint)
Esta es la copia VIVA. El congelado de M4 está en docs/baseline/ y NO se toca.
-->

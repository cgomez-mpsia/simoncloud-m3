...
## Activation context
Este skill se activa cuando se solicita crear, revisar o ampliar el `docs/mrd/MRD_vFinal.md` de SimonCloud, incluyendo personas, segmentos, JTBDs, análisis competitivo o hipótesis.

## Context / Inputs requeridos
- `docs/brd/BRD_vFinal.md` — Contexto de negocio de la UMSS.
...
2. Identificar el segmento de mercado correspondiente (Estudiante, Docente, Administrativo, Usuario Externo, Docente Investigador).
...
## Output esperado
- Sección nueva o ampliada en `docs/mrd/MRD_vFinal.md`.
